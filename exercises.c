...
Vector * crearVector(int n) {
   ...
   ptr->capacidad=n;
   ptr->datos=(int*)calloc(n,sizeof(int*));
...
*/
void sumaV(Vector * a, Vector * b, Vector * c) {//no se si todos van ser del mismo tamaño,voy a deducir que si
   int talla=c->capacidad;
